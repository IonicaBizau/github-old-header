...
var me = $(".dropdown-item:contains('Your profile')").attr("href").substr(1);
...
$(".header-nav.left").html(
  ...
  + "<li class='header-nav-item'><a href='/help' class='js-selected-navigation-item header-nav-link'>Help</a></li>"
